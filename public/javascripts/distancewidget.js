...
function DistanceWidget(opt_options) {
  ...
  if (!this.get('position')) {
    this.set('position', options.map.getCenter()); //map.getCenter());
  }
  // Add a marker to the page at the map center or specified position
  var marker = options.homeMarker;
  ...
  radiusWidget.bindTo('fillColor', this);
  radiusWidget.bindTo('fillOpacity', this);
